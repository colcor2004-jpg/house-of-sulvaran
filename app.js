...
function renderProducts(limit = null) {
    ...
    grid.innerHTML = products.map(p => {
        ...
        const mainImg = images[0] || 'logo.jpg';
        ...
        <div class="product-card fade-in ${opacityClass}">
            <div class="product-gallery-main">
                <img src="${mainImg}" alt="${p.name}" class="product-image" onerror="this.src='logo.jpg'" onclick="openProductLightbox('${encodeURIComponent(JSON.stringify(images))}')">
